<?php 
	...
	class QueryExtractor {
		...
		public function __construct($xml_file_name) {
			$this->xml = str_get_html(file_get_contents(dirname(__FILE__).'/'.$xml_file_name));
		}
		
		public function extractByName($name) {
			return $this->xml->find("query[name=$name]")[0]->plaintext;
		}
	}
